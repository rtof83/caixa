...
type
  TdtmDados = class(TDataModule)
    ...
    qryAlunoVencimento: TIntegerField;
    qryAlunoHorario: TDateTimeField;
    qryAlunoPlano: TWideStringField;
    ...
    qryAlunoGrSangue: TWideStringField;
    qryAlunoConvenio: TBooleanField;
    qryAlunoConvenioNome: TWideStringField;
    qryAlunoHospital: TWideStringField;
    qryAlunoContatoEmergencia: TWideStringField;
    qryAlunoTelefoneEmergencia1: TWideStringField;
    qryAlunoTelefoneEmergencia2: TWideStringField;
    qryAlunoObservacao: TWideMemoField;
    qryAlunoDesconto: TSmallintField;
    ...
    qryAtivosObservacao: TWideMemoField;
